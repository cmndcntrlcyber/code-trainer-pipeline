...
def _render_model_card(base_model, adapter_repo, gguf_files):
    ...
    model_tag = base_model.split("/")[-1].lower().split("-it")[0].replace("-", "-")
    return f"""---
